...
public class ListOfAdapter extends RecyclerView.Adapter<ListOfAdapter.ListHolder> {
    private ArrayList<DBOfHelper> arrayList;
    private Context context;
    private DBOfHelper dbHelper;
    private FirebaseDatabase firebaseDatabase;
    private DatabaseReference databaseReference;
    public ListOfAdapter(ArrayList<DBOfHelper> arrayList,Context  context) {
    ...
    public ListHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.list_of_items,parent,false);
        return new ListHolder(view);
    }
    @Override
    public void onBindViewHolder(@NonNull ListHolder holder, @SuppressLint("RecyclerView") int position) {
        Intent i = new Intent(context, MinorActivity.class);
